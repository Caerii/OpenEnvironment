# Semantic Terrain System - Engineering Explanation

## Overview

**Semantic Terrain** is a real-time terrain generation system that converts natural language commands (e.g., "add two mountains on the left") into procedural 3D terrain with heightmaps and splatmaps. The system uses an LLM-powered parser, a semantic scene graph for reference resolution, and a deterministic terrain engine.
...
**Semantic Terrain** is a sophisticated system that combines:
