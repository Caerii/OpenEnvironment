...
**⚠️ NOTE:** This document describes the parser integration as of November 7, 2025. As of November 11, 2025, the parser order has changed: **Narrative Pipeline is now PRIMARY**, SemanticParser is fallback. See `CURRENT_ARCHITECTURE_STATUS.md` for current state.
...
- **Narrative Pipeline** is now PRIMARY (called first)
- SemanticParser is SECONDARY fallback
- CommandParser is FINAL fallback
