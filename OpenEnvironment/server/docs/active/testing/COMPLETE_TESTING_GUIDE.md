...
**Note:** Primitive count has changed. See `feature_registry.py` for current registered primitives. Core 6 primitives: mountain, valley, dunes, cliff, plateau, canyon. Additional specialized primitives: mesa, crater, and walkability zones (flat_zone, path, clearing).

---

## 🎯 Available Primitives (Core 6 + Specialized)
